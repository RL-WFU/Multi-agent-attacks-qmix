...
class Runner:
    ...
    def evaluate(self):
        ...
        for epoch in range(self.args.evaluate_epoch):
            #============>
            self.episode, episode_reward, win_tag, _, self.data_set, self.adv_data, self.q_diff, transition = self.rolloutWorker.generate_episode(epoch, evaluate=True, black_box=not self.args.white_box, bb_net=self.bb_net)
