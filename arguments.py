...
def get_common_args():
    ...
    parser.add_argument('--attack_name',type=str, default="counterfactual", help='Which Adversarial attack to use')
    parser.add_argument('--white_box', type=bool, default=True, help='White or black box')
